	...
	protected function _enqueue_static($id, $option, $data)
	{
		// adaptive switch
		{
			wp_enqueue_style(
				...
				fw_get_framework_asset_uri('/includes/option-types/'. $this->get_type() .'/static/adaptive-switch/styles.css'),
				array(),
			...
			wp_enqueue_script(
				'fw-option-'. $this->get_type() .'-adaptive-switch',
				fw_get_framework_asset_uri('/includes/option-types/'. $this->get_type() .'/static/adaptive-switch/jquery.adaptive-switch.js'),
				array('jquery'),
				fw()->manifest->get_version(),
				true
			);
