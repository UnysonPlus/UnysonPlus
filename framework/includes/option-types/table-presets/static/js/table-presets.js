...
(function ($) {
	...
	function initItem($item) {
		...
		$item.on('click', '.fw-option-type-table-presets-item-header', function (e) {
			if ($(e.target).closest('.fw-option-type-table-presets-item-handle, .fw-option-type-table-presets-item-duplicate, .fw-option-type-table-presets-item-remove').length) {
				return;
			}
			e.preventDefault();
	...
	$(document).on('click', '.fw-option-type-table-presets-item-duplicate', function (e) {
		e.preventDefault();
		duplicateItem($(this).closest('.fw-option-type-table-presets-item'));
	});
	...
	function duplicateItem($item) {
		...
		$clone.removeData('tp-init').removeAttr('data-tp-init');
