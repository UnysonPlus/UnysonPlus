...
$box_view = fw_get_framework_directory( '/includes/option-types/table-presets/views/box.php' );
?>
<div
	class="fw-option-type-table-presets"
...
>
	...
	?>
	<div class="fw-option-type-table-presets-list">
		<?php
	...
	<div class="fw-option-type-table-presets-controls">
		<a href="#" class="fw-option-type-table-presets-add button button-primary dashicons-before dashicons-plus">
			<?php esc_html_e( 'Add Table Preset', 'fw' ); ?>
		</a>
	</div>
</div>
