...
(function() {
	...
	ImagePickerOption = (function() {
		...
		ImagePickerOption.prototype.create_node = function() {
			...
			if (this.option.data('small-img-attr')) {
				$image.attr(this.option.data('small-img-attr'));
			} else {
				// this is the blank option
			}

			$image.addClass('image_picker_image');

			if (this.option.attr('data-large-img-attr')) {
				$image.attr('data-large-img-attr', this.option.attr('data-large-img-attr'));
			}

			var $thumbnail = jQuery('<div class="thumbnail">');
