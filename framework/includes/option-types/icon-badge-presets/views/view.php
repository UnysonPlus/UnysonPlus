...
$box_view = fw_get_framework_directory( '/includes/option-types/icon-badge-presets/views/box.php' );
?>
<div
	class="fw-option-type-icon-badge-presets"
...
>
	...
	?>
	<div class="fw-option-type-icon-badge-presets-list">
		<?php
	...
	<div class="fw-option-type-icon-badge-presets-controls">
		<a href="#" class="fw-option-type-icon-badge-presets-add button button-primary dashicons-before dashicons-plus">
			<?php esc_html_e( 'Add Icon Badge', 'fw' ); ?>
		</a>
	</div>
</div>
