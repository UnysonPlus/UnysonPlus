...
$extensions = [
    ...
    'site-migration' => [
        ...
        'description' => __('Moves a whole WordPress site to another install. The destination shows a connection key, you paste it into the source, and the source pushes everything — database, uploads, themes and plugins — in resumable background slices that survive PHP timeouts and a closed browser.', 'fw'),
    ...
    'seo' => [
        ...
        'parent'      => null,
        'name'        => __('SEO', 'fw'),
        'description' => __('Search engine optimisation: dynamic title and description templates with auto-generation, a live search-result preview, canonical URLs and indexing control.', 'fw'),
