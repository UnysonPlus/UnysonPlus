...
if ( defined( 'FW' ) ) {
         ...
         */
        {
                ...
                // The "recommend the Classic Editor plugin" admin notice was removed: the Page Editor
				// extension now replaces the block editor with WordPress's built-in classic editor itself,
